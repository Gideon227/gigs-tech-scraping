...
#             instruction="""
#            Extract the following job-related fields from the HTML content of the job page:
#                     jobId, title, description, location, country, state, city, jobType, salary, skills,
#                     experienceLevel, currency, applicationUrl, benefits, approvalStatus, brokenLink,
#                     jobStatus, responsibilities, workSettings, roleCategory, qualifications,
#                     companyLogo, companyName, ipBlocked, minSalary, maxSalary, postedDate, category
#                     Return the result as a Python dictionary with matching keys.
#                     Notes:
#                     - In the 'salary' field, if the rate is listed per month, hour, etc., include that detail. Use an empty string or a sensible default if not found.
#                     - Classify the job into one of the following categories based on the title or description: "developer", "consultant", "sales", "administrator", or "engineer".
#                     - The 'roleCategory' should be inferred from the job title or job context.
#             """,
#             extra_args=extra_args,
#         ),
#     )
